...
namespace RPA_SummerProj.core.module
{
    ...
    public sealed class OutlookFindByBody : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            string tgtBody = context.GetValue(this.mailBody);
            string tgtFilder = context.GetValue(this.folderName);
            MailManager myMail = new MailManager();
            myMail.findMailByBody(tgtBody, tgtFilder);
        }
    }
}

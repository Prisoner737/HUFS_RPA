    ...
    public partial class Form1 : Form
    {
        ...
        private void Example_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            WorkflowApplication create = new WorkflowApplication(new Create(), commonInput);
            WorkflowApplication open = new WorkflowApplication(new Open(), openInput);
            WorkflowApplication append = new WorkflowApplication(new Append(), commonInput);
            WorkflowApplication write_cell = new WorkflowApplication(new Write_Cell(), writeInput);
            WorkflowApplication write_range = new WorkflowApplication(new Write_Range(), writeInput2);
            WorkflowApplication read_cell = new WorkflowApplication(new Read_Cell(), readInput);
            WorkflowApplication read_range = new WorkflowApplication(new Read_Range(), readInput2);
            WorkflowApplication save = new WorkflowApplication(new Save(), saveInput);
            WorkflowApplication close = new WorkflowApplication(new Close(), commonInput);
